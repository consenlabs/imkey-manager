let BTC_PATH_PREFIX = "m/44'/0'/0'";
let BITCOIN_TESTNET_PATH = "m/44'/1'/0'";
let BTC_SEGWIT_PATH_PREFIX = "m/49'/0'/0'/";
let BITCOIN_SEGWIT_TESTNET_PATH = "m/49'/1'/0'/";
let ETH_LEDGER = "m/44'/60'/0'/0/0";
