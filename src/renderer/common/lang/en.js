...
export const m = {
  ...
  dapp: {
    ...
    Autofarm_desc: 'AutoFarm聚集了 BSC 上最好的保管库，并实施了最佳策略来最大化用户的收益',
    PancakeBunny_desc: '用于 PancakeSwap 的新型且快速增长的DeFi挖矿聚合器',
    ...
    Channels_desc: '专注于主流借贷币种 HUSD、USDT、ETH、HBTC 和HT 等',
