...
export const m = {
  imKeyManager: {
    ...
    installing_dot_ksm_coin: 'Please go to the manager page to install the applet DOT and KSM'
  },
  appStart: {
    imKey_manager: 'imKey Manager',
    your_imKey_manager: 'Your imKey Pro desktop management tool',
  ...
  dapp: {
    ...
    Venus_desc: '去中心化的算法货币市场和稳定币协议，使借款人和供应商能够按需获得流动性和收益。',
    pancake_desc: '允许在Binance智能链上交换两个代币。它速度快，价格便宜，并且任何人都可以参加。',
    Autofarm_desc: 'AutoFarm聚集了BSC上最好的保管库，并实施了最佳策略来最大化用户的收益',
    PancakeBunny_desc: '用于PancakeSwap的新型且快速增长的DeFi挖矿聚合器',
    Belt_Finance_desc: '具有低费用/滑点，还通过vault复合，借贷和收益率生成提供聚合',
    beefy_finance_desc: '收益更高，且不必担心不断地提高APY所必需的相互作用量。',
    Bscex_LaunchpoolX_desc: '构建Binance交易所Launchpool的链上版本',
    ACryptoS_desc: '通过自动收益策略来增加您的资产',
    Alpaca_Finance_desc: '基于Binance Smart Chain的杠杆式收益挖矿协议',
    Goose_Finance_desc: 'Binance Smart Chain上第一个删除迁移器代码的收益挖矿项目',
    MDEX_desc: '融合多种基础公链的差异化优势，打造高性能复合型DEX生态',
    BXH_desc: 'DEX创新交易平台，是⼀个社区⾃治、⾃动做 市(AMM)的去中⼼化交易所',
    CoinWind_desc: 'DeFi智能挖矿金融平台',
    Lendhub_desc: '基于火币生态链的去中心化借贷平台',
    FilDA_desc: '全球首个基于HECO的跨链借贷DeFi项目',
    EarnDefi_desc: '一站式DEFI协议，专挖头矿，具有聚合理财、交易、跨链等功能。',
    Channels_desc: '专注于主流借贷币种HUSD、USDT、ETH、HBTC和HT等',
    HFI_one_desc: '基于 Heco 生态链的去中心化聚合挖矿平台',
    Pippi_Shrimp_Swap_desc: '基于火币智能链（Heco）的去中心化交易平台',
    HashBridge_desc: '提供一整套完善的数据服务方案',
    JulSwap_desc: '提供与Uniswap相同的交易引擎和分析功能，以及Sushiswap的一些其他功能'
  },
  imKeyCoreErrorInfo: {
