...
export const m = {
  imKeyManager: {
    ...
    imKey_pro_ble_update_prompt_message: '注意：升级成功后需删除蓝牙配对信息重新配对',
  ...
  dapp: {
    ...
    pancake_desc: '允许在 Binance 智能链上交换两个代币。它速度快，价格便宜，并且任何人都可以参加',
    Autofarm_desc: 'AutoFarm 聚集了 BSC 上最好的保管库，并实施了最佳策略来最大化用户的收益',
    PancakeBunny_desc: '用于 PancakeSwap 的新型且快速增长的 DeFi 挖矿聚合器',
    Belt_Finance_desc: '具有低费用/滑点，还通过 vault 复合，借贷和收益率生成提供聚合',
    beefy_finance_desc: '收益更高，且不必担心不断地提高APY所必需的相互作用量',
    Bscex_LaunchpoolX_desc: '构建 Binance 交易所 Launchpool 的链上版本',
