<template>
    <v-app light>
        <v-navigation-drawer
                ...
                :mini-variant="mini"
        >
            <v-container fluid headline font-weight-thin text-lowercase
                         style="-webkit-user-select: none;-webkit-app-region: drag"
            v-show="!mini"
            >
                <v-layout>
                    <v-flex layout justify-between align-end>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            items: [
                {heading: 'Home'},
                {isSingle: true, icon: 'home', text: 'home', to: '/home'},
                {heading: 'Manager'},
                // {
                //     isGroup: true,
                //     icon: 'list',
                ...
                //     ]
                // },
                {isSingle: true, icon: 'featured_video', text: 'Device', to: '/Device'},
                {isSingle: true, icon: 'apps', text: 'App', to: '/App'},
                {divider: true},
                {heading: 'System'},
