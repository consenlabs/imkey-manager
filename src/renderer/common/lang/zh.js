...
export const m = {
  imKeyManager: {
    ...
    imKey_pro_ble_update_prompt_message: '注意：升级成功后需手动重启设备并删除蓝牙配对信息重新配对',
  ...
  dapp: {
    ...
    sushiswap_desc: '锁定 SushiSwap LP 代币，领取属于您的美味 SUSHI!',
    uniswap_desc: '保证数百万用户和数百个 Ethereum 应用的流动性',
    polkadotJS_desc: '加密货币交易所｜简单的硬币兑换方式',
    multisender_desc: '将 ERC20 代币或 ETH 发送到成千上万的地址，只需一次交易......',
