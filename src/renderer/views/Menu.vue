<template>
  <div class="home">
    <div>
      ...
      <div class="btns" @click="goDeviceLine">
        <span>
          <i class="el-icon-plus"></i>
          Initialize a new imKey Pro device
        </span>
...
<!--      </div>-->
      <!-- <div class="btns">
        <span>
          ...
          use a device that already initial
        </span>
        <span class="el-icon-arrow-right"></span>
      </div>-->
      <!-- <div class="btns">
        <span>
          ...
          don't have a Ledger device yet?
        </span>
        <span class="el-icon-arrow-right"></span>
      </div>-->
    </div>
