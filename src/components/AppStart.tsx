...
export default function AppStart() {
  ...
  return (
    <div className="appStart">
        ...
        <h2>{t('imKeyManager.imKey_manager')}</h2>
        <p>{t('imKeyManager.your_imKey_manager')}</p>
        <p>
            <button onClick={next}>{t('imKeyManager.use_now')}</button>
        </p>
        <p><i></i><span className="link0" onClick={openUrl}>{t('m.imKeyManager.no_have_imKey_pro')}</span></p>
    </div>
  );
}