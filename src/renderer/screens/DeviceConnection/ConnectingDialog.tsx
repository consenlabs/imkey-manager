    ...
    <Grid.Container alignItems="center" justify="center">
      ...
      >
        <li>
          ...
          {t('imKeyManager.check_firmware_version_update')}
        </li>
        <li>
          <InlineSpinner /> {t('imKeyManager.check_device_bind_code')}
        </li>
        <li>
          <CheckIcon /> {t('imKeyManager.check_pin_wallet')}
        </li>
        <li>
          <CheckIcon /> {t('imKeyManager.check_secure_test')}
        </li>
      </ul>
