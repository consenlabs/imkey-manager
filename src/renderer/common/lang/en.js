...
export const m = {
  imKeyManager: {
    ...
    if_bind_device_disconnect_bluetooth: '* If the mobile device has been bound, you need to turn on imKey Pro and disconnect the Bluetooth connection',
    connect: 'Connect',
    ...
    pin_code_error_please_check: 'PIN code error/forgotten can be retrieved by resetting imKey',
    ...
    found_imKey_manager_new_version: 'New version of imKey Manager FOUND!',
    update: 'Upgrade',
