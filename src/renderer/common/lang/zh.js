...
export const m = {
  ...
  dapp: {
    ...
    sushiswap_desc: '锁定 SushiSwap LP代币，领取属于您的美味 SUSHI!',
    ...
    pancake_desc: 'Decentralized algorithmic currency markets and stablecoin protocols that enable borrowers and vendors to access liquidity and revenue on demand.',
    Autofarm_desc: 'AutoFarm 聚集了 BSC上最好的保管库，并实施了最佳策略来最大化用户的收益',
    ...
    FilDA_desc: '全球首个基于 HECO 的跨链借贷DeFi项目',
    EarnDefi_desc: '一站式 DEFI 协议，专挖头矿，具有聚合理财、交易、跨链等功能。',
    Channels_desc: '专注于主流借贷币种 HUSD、USDT、ETH、HBTC和HT等',
