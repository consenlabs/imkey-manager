...
export const m = {
  imKeyManager: {
    ...
    find_firmware_update_fail_contniue: '检测到因应用异常退出导致固件升级未完成，请继续升级，完成后可正常使用 imKey Manager'
    // 'mKey Pro 固件版本升级中，请耐心等待',
    // '注意：升级完成后 imKey Pro 将自动重启升级过程中请勿断开 USB 连接，同时中止 imKey 操作',
    // '请输入设备绑定码',
    // '绑定码错误，请仔细核对，或通过导入助记词 重置 imKey 找回',
    // '请在 imKey Pro 中输入 PIN 码',
    // 'PIN 码错误 / 遗忘可以通过 重置 imKey 找回',
    //
    // 'imKey 设置',
    // '请在 imKey 上完成以下操作：',
    // '生成设备绑定码',
